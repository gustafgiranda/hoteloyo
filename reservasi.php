        ...
        <table border="1">
            ...
            <?php while ($value = mysqli_fetch_assoc($query)) { ?>
                <tr>
                    ...
                    <td><?= $value["tipe"] ?></td>
                    <td>    
                        <a href="hapus_reservasi.php?id=<?= $value["kode_booking"] ?>">HAPUS</a>
                        <a href="edit_reservasi.php?id=<?= $value["kode_booking"] ?>">EDIT</a>
                    </td>
                </tr>
            <?php } ?>
        </table>
        <a href="input_reservasi.php">MASUKKAN DATA</a>
    </body>
    </html>
